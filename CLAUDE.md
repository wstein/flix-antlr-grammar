...
- [x] Syntax reference and railroad diagrams -- `docs/SYNTAX.md` (mechanical, all 85 rules) and
      `docs/RAILROAD.md` (curated Mermaid diagrams), both generated by `node tools/gen-docs.mjs`
      and checked in CI (`Verify generated documentation is current`). This item was done as of
      commit 7e0980b; the checklist just wasn't updated to say so.
